  ...
  return (
    <section className="w-full py-16 flex items-center justify-center">
      <div className="w-full max-w-7xl px-4">
        <div className="relative bg-gradient-to-b from-[#501bd6] to-[#7f57e2] rounded-[24px] px-10 py-12 flex flex-col gap-6 items-center justify-center text-center text-white overflow-hidden">
          ...
          <div className="relative z-10 w-full flex flex-col gap-6 items-center justify-center">
            ...
            <div className="flex flex-col gap-5 items-center text-center w-full">
              <h2
                className="text-[48px] leading-[60px] font-semibold capitalize w-full"
                style={{ fontFamily: "Plus Jakarta Sans" }}
              >
                Get Weekly Saving Tips
              </h2>
              <div
                className="text-[20px] leading-[32px] font-medium w-full"
                style={{ fontFamily: "Plus Jakarta Sans" }}
              >
                <p className="mb-0">
            ...
            <div className="flex gap-6 items-center w-full max-w-[628px]">
              {/* Email Input Field */}
