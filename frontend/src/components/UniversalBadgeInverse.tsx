...
interface UniversalBadgeInverseProps {
...
export const UniversalBadgeInverse: React.FC<UniversalBadgeInverseProps> = ({
  badgeText,
  secondaryText,
  icon = "electric",
  className = "",
  ...
  return (
    <div
      className={`box-border content-stretch flex items-center justify-center relative rounded-[100px] ${sizeConfig[size].container} ${className}`}
      style={{ background: "var(--Primary-50, #F4F4F5)" }}
      onClick={onClick}
    >
      ...
      {secondaryText && (
        <div
          className={`text-black font-['Plus_Jakarta_Sans:Medium',_sans-serif] font-medium leading-[0] relative shrink-0 text-center whitespace-nowrap ${sizeConfig[size].secondaryText}`}
        >
