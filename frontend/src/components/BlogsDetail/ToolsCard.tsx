...
export default function ToolsCard({
  ...
  return (
    ...
    >
      ...
      <div
        data-layer="Filter"
        className="Filter w-[200px] self-stretch inline-flex flex-col justify-between items-start"
      >
        <div
        ...
        >
          <div
            data-layer="Redeem"
            className="Redeem justify-start text-white text-base font-normal font-['Poppins'] leading-normal"
          >
            {primaryActionText}
          </div>
        </div>
        ...
        >
          <div
            ...
            className="ViewDetails justify-start text-neutral-50 text-base font-normal font-['Poppins'] leading-normal"
          >
            {secondaryActionText}
          </div>
        </div>
