...
export default function ToolsCard({
  ...
  return (
    ...
    >
      ...
      <div
        data-layer="Filter"
        className="Filter w-full lg:w-[200px] self-stretch inline-flex flex-row lg:flex-col justify-around items-start gap-4"
      >
        <div
        ...
        >
          <div
            data-layer="Redeem"
            className="Redeem justify-start w-[150px] text-center text-white text-base font-normal font-['Poppins'] leading-normal"
          >
            {primaryActionText}
          </div>
        </div>
        ...
        >
          <div
            ...
            className="ViewDetails justify-start w-[150px] text-center text-neutral-50 text-base font-normal font-['Poppins'] leading-normal"
          >
            {secondaryActionText}
          </div>
        </div>
