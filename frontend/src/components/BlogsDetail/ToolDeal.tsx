export default function ToolDeal() {
  return (
    <div
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Every communications experience, Integrated contact center, voice,
              video, chat, and APIs.
            </div>
            <div
      ...
      >
        ...
        >
          Boost Your Content Output by 10x!
        </div>
        <div
        ...
        >
          Unlock Jasper AI with an exclusive discount and cashback only on
          DealYouNeed. Stop writing, start generating! This deal gives you
          access to all premium features at a fraction of the regular price.
        </div>
        <div
