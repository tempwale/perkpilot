...
export default function DealGrid({
  ...
  const displayDeals = maxItems ? deals.slice(0, maxItems) : deals;
  ...
  return (
    <div className="w-full">
      ...
      {maxItems && deals.length > maxItems && (
        <div className="flex justify-center mt-8">
          <button className="bg-[rgba(255,255,255,0.08)] hover:bg-[rgba(255,255,255,0.12)] border border-[rgba(255,255,255,0.16)] text-white px-8 py-3 rounded-full transition-colors">
            Load More Deals
          </button>
        </div>
      )}
