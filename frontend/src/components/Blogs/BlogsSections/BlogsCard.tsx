...
const BlogsCard: React.FC<BlogsCardProps> = ({
  ...
  return (
    <Link
      to={`/blog/${id}`}
      className="w-[608px] p-6 bg-white/5 rounded-3xl shadow-[0px_1px_4px_0px_rgba(12,12,13,0.05)] outline outline-1 outline-offset-[-1px] outline-white/10 inline-flex flex-col justify-center items-start gap-6"
    >
      {/* Image Section */}
