    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M8.45852 10.7713C8.36453 10.7713 8.27359 10.7537 8.18571 10.7184C8.09736 10.6832 8.02382 10.6362 7.96507 10.5775L4.72242 7.3348C4.59318 7.20557 4.52856 7.04108 4.52856 6.84135C4.52856 6.64163 4.59318 6.47714 4.72242 6.34791C4.85165 6.21867 5.01614 6.15405 5.21587 6.15405C5.41559 6.15405 5.58008 6.21867 5.70931 6.34791L8.45852 9.09711L11.2077 6.34791C11.337 6.21867 11.5014 6.15405 11.7012 6.15405C11.9009 6.15405 12.0654 6.21867 12.1946 6.34791C12.3239 6.47714 12.3885 6.64163 12.3885 6.84135C12.3885 7.04108 12.3239 7.20557 12.1946 7.3348L8.95197 10.5775C8.88147 10.6479 8.80511 10.6978 8.72287 10.7269C8.64062 10.7565 8.55251 10.7713 8.45852 10.7713Z"
                fill="#FAFAFA"
              />
            </svg>
          </div>
      ...
      >
        ...
        >
          ...
          >
            <path
              d="M8.10664 14.8034C11.8052 14.8034 14.8034 11.8051 14.8034 8.10658C14.8034 4.40804 11.8052 1.40979 8.10664 1.40979C4.4081 1.40979 1.40985 4.40804 1.40985 8.10658C1.40985 11.8051 4.4081 14.8034 8.10664 14.8034Z"
              stroke="white"
              stroke-width="1.05739"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M15.5084 15.5084L14.0985 14.0985"
              stroke="white"
              stroke-width="1.05739"
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      >
        ...
        <div
          ...
          className="Frame1171275749 self-stretch relative h-[4.23px]"
        >
          <div
            data-layer="Rectangle"
            className="Rectangle absolute left-0 top-0 w-full h-[4.23px] bg-neutral-50 rounded-[2.82px]"
          />
          <div
            data-layer="Rectangle"
            className="Rectangle absolute left-0 top-0 w-[306.73px] h-[4.23px] bg-gradient-to-b from-[#501bd6] to-[#7f57e2] rounded-[2.82px] z-10"
          />
        </div>
        <div
          data-layer="Ellipse 6069"
          className="Ellipse6069 w-[11.28px] h-[11.28px] left-[301.10px] top-[14.80px] absolute bg-gradient-to-b from-[#501bd6] to-[#7f57e2] rounded-full"
        />
      </div>
      <div
