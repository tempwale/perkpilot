    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-zinc-300 text-base font-normal font-['Plus_Jakarta_Sans'] leading-normal">
            Safety Check: We instantly scan against known breach databases to
            confirm the password has No Breaches Found.
            <br />
          </span>
          <span className="text-zinc-300 text-base font-normal font-['Plus_Jakarta_Sans'] leading-normal">
            <br />
          ...
          <span className="text-zinc-300 text-base font-normal font-['Plus_Jakarta_Sans'] leading-normal">
            Crack Time Calculation: We provide a calculated Crack Time and AI
            Recommendation to prove that your new, Quantum-Safe password is
      ...
      <div
        ...
        className="Rectangle39991  w-[400px] md:w-[608px] h-[400px] bg-white/10 rounded-2xl flex justify-center items-center"
      >
        <div
        ...
        >
          ...
          >
            <div
              data-layer="shield-broken"
              className="ShieldBroken w-[21.05px] h-[21.05px] left-[7.89px] top-[7.89px] absolute overflow-hidden"
            >
              <svg
          ...
          >
            ...
            <div
              ...
              className="Frame1171275749 self-stretch relative h-1"
            >
              <div
                data-layer="Rectangle"
                className="Rectangle absolute left-0 top-0 w-full h-1 bg-zinc-300 rounded-sm"
              />
              <div
                data-layer="Rectangle"
                className="Rectangle absolute left-0 top-0 w-[326.43px] h-1 bg-gradient-to-b from-[#501bd6] to-[#7f57e2] rounded-sm z-10"
              />
            </div>
          </div>
          <div
