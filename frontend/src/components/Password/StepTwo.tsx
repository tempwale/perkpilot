  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            ...
            className="Frame2147206329 w-[322.61px] flex flex-col justify-start items-center gap-[12.36px]"
          >
            <div
            ...
            >
              ...
              >
                <div
                  ...
                  className="Rectangle w-[322.61px] h-[4.64px] bg-gradient-to-b from-[#501bd6] to-[#7f57e2] rounded-[3.09px]"
                />
              </div>
              <div
      ...
      >
        ...
        >
          Our AI system takes your inputs and simultaneously injects the highest
          measurable level of Entropy Power. This unique process ensures the
          password is fully randomized and unpredictable, achieving Maximum
          Protection (Level 4/4) every single time.
        </div>
      </div>
    </div>
  );
